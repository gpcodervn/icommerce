package com.icommerce.audit.configuration.security;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http
				...
				.antMatchers(HttpMethod.POST, "/v1/customer-audits/**").hasAnyRole(AuthRole.ADMIN.name(), AuthRole.CUSTOMER.name())
				.antMatchers(HttpMethod.GET, "/v1/customer-audits/**").hasAnyRole(AuthRole.ADMIN.name())
